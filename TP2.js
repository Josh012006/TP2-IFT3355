...
class Robot {
    ...
    updateHuman() {
        boneDict["Spine"].matrix = matMul(this.spine.matrix, invert(matMul(boneDict["Spine"].matrixWorld, translation(0, this.spineLength/2, 0))));
        boneDict["Chest"].matrix = matMul(this.chest.matrix, invert(matMul(boneDict["Chest"].matrixWorld, translation(0, this.chestLength/2, 0))));
        boneDict["Neck"].matrix = matMul(this.neck.matrix, invert(matMul(boneDict["Neck"].matrixWorld, translation(0, this.neckLength/2, 0))));
        boneDict["Head"].matrix = matMul(this.head.matrix, invert(matMul(boneDict["Head"].matrixWorld, translation(0, this.headLength/2, 0))));
        boneDict["Arm_L"].matrix = matMul(this.armLeft.matrix, invert(matMul(boneDict["Arm_L"].matrixWorld, translation(0, this.armLength/2, 0))));
        boneDict["Forearm_L"].matrix = matMul(this.forearmLeft.matrix, invert(matMul(boneDict["Forearm_L"].matrixWorld, translation(0, this.forearmLength/2, 0))));
        boneDict["Arm_R"].matrix = matMul(this.armRight.matrix, invert(matMul(boneDict["Arm_R"].matrixWorld, translation(0, this.armLength/2, 0))));
        boneDict["Forearm_R"].matrix = matMul(this.forearmRight.matrix, invert(matMul(boneDict["Forearm_R"].matrixWorld, translation(0, this.forearmLength/2, 0))));
        boneDict["Leg_L"].matrix = matMul(this.legLeft.matrix, invert(matMul(boneDict["Leg_L"].matrixWorld, translation(0, this.legLength/2, 0))));
        boneDict["Shin_L"].matrix = matMul(this.shinLeft.matrix, invert(matMul(boneDict["Shin_L"].matrixWorld, translation(0, this.shinLength/2, 0))));
        boneDict["Leg_R"].matrix = matMul(this.legRight.matrix, invert(matMul(boneDict["Leg_R"].matrixWorld, translation(0, this.legLength/2, 0))));
        boneDict["Shin_R"].matrix = matMul(this.shinRight.matrix, invert(matMul(boneDict["Shin_R"].matrixWorld, translation(0, this.shinLength/2, 0))));
